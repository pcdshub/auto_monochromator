"""
Script for small utility functions used in auto_monochromator
"""
############
# Standard #
############
...
def absolute_submodule_path(submodule, cur_dir=inspect.stack()[0][1]):
    """
    Returns the absolute path of the inputted auto_monochromator submodule 
...
DIR_MODULE = Path(absolute_submodule_path("auto_monochromator/"))
